...
var routes = (
    <Router.Route handler={require('./components/App')}>
        ...
        <Router.Route name="units" path="/world/:worldId/units/" handler={require('./components/Units')} />
        <Router.Route name="quest-demo" path="/world/:worldId/quest-demo/" handler={require('./components/QuestDemo')} />
    </Router.Route>
)
